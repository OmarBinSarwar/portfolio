...
export function ProjectsSection() {
  ...
  return (
    <div className="section-shell section-projects min-h-screen w-full flex items-center justify-center px-4 sm:px-6 pt-20 sm:pt-24 md:pt-28 pb-28 sm:pb-32 md:pb-24 lg:pb-24">
